...
:Version: 0.0.0
:Web: https://github.com/luismayta/zsh-resources
:Download: https://github.com/luismayta/zsh-resources
:Source: https://github.com/luismayta/zsh-resources
:Keywords: zsh-resources
...
2. Clone the plugin
    ``bash   git clone https://github.com/luismayta/zsh-resources``\ bash
3. Edit your ``.zshrc`` and add
    ``plugins=( ... zsh-resources )`` to your list of
    plugins
...
1. Add ``antibody bundle luismayta/zsh-resources`` to your
    ``.zshrc`` where you're adding your other plugins.
2. Either open a new terminal to force zsh to load the new plugin, or
    run ``antibody bundle luismayta/zsh-resources`` in a
    running zsh session.
3. Enjoy!
...
.. |Build Status| image:: https://travis-ci.org/luismayta/zsh-resources.svg
    :target: https://travis-ci.org/luismayta/zsh-resources
