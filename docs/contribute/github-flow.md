...
To contribute to zsh-resources project on [GitHub](https://github.com/hadenlabs/zsh-resources), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/zsh-resources/pulls).
...
To follow the instructions in this guide and start contributing to zsh-resources project on GitHub:
...
```bash
git remote add upstream  https://github.com/hadenlabs/zsh-resources.git
```

Now your **upstream** points to **hadenlabs/zsh-resources**.
...
git fetch upstream # assuming upstream is hadenlabs/zsh-resources
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/zsh-resources/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
