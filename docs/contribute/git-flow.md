...
To contribute to zsh-resources project on [GitHub](https://github.com/hadenlabs/zsh-resources), We use Gitflow (See more [here](https://datasift.github.io/gitflow/IntroducingGitFlow.html)) In a nutshell, it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/zsh-resources/pulls).

![workflow gitflow](https://datasift.github.io/gitflow/GitFlowHotfixBranch.png)

## Getting started

To follow the instructions in this guide and start contributing to zsh-resources project on Gitlab:
...
git fetch upstream # assuming upstream is rfid/zsh-resources
